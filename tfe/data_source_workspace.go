...
func dataSourceTFEWorkspace() *schema.Resource {
	return &schema.Resource{
		DeprecationMessage: "Data source \"tfe_workspace\"\n\n\"external_id\": [DEPRECATED] Use id instead. The external_id attribute will be removed in the future. See the CHANGELOG to learn more: https://github.com/hashicorp/terraform-provider-tfe/blob/v0.2X.0/CHANGELOG.md",
		...
		Schema: map[string]*schema.Schema{
			...
			"external_id": {
				Type:       schema.TypeString,
				Computed:   true,
				Deprecated: "Use id instead. The external_id attribute will be removed in the future. See the CHANGELOG to learn more: https://github.com/hashicorp/terraform-provider-tfe/blob/v0.2X.0/CHANGELOG.md",
			},
		},
	}
}
